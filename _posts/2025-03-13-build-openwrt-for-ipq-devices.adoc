...
=== Configure feed-ipq repo in feeds.conf.default
...
=== Bump Kernel version for IPQ targets
...
=== Install IPQ targets from feed-ipq
...
List of OpenWrt Firmware Images generated for IPQ devices
...
== References
  ...
  * https://github.com/zilogic-systems/feed-ipq/blob/ath.13.0/README.md
